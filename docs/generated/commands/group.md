...
Stack: feature/auth (3 commits)
   ...
   1  0b3c6f9  Add login form                           [A: Auth Flow]
▶  2  21a278f  Add session handling                     [A]
   3  a802708  Fix typo in README
...
Stack: feature/auth (2 commits)
   ...
   1  a965cda  Add login form                           [A: Auth▌]
▶  2  6a68f81  Add session handling                     [A]
...
●  1  6bfe168  Add session handling
   2  7cfd02c  Add login form
...
●  1  75250de  Set version to 2                         ⚠
   2  3087743  Set version to 1                         ⚠
