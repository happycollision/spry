...
Stack: feature/auth (3 commits)
   ...
   1  e7d4a1c  Add login form                           [A: Auth Flow]
▶  2  0b3c6f9  Add session handling                     [A]
   3  9c6a3f0  Fix typo in README
...
Stack: feature/auth (2 commits)
   ...
   1  b29ee11  Add login form                           [A: Auth▌]
▶  2  b054c24  Add session handling                     [A]
...
●  1  f78df0c  Add session handling
   2  3cd28bc  Add login form
...
●  1  2d7f4a1  Set version to 2                         ⚠
   2  8e3b6f1  Set version to 1                         ⚠
