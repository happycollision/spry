...
- `sp sync --open` no longer hangs when opening a pull request whose body is empty (the gh client now redirects empty stdin instead of inheriting the terminal's).
